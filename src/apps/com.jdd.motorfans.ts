      ...
      rules: [
        {
          ...
          snapshotUrls: [
            'https://i.gkd.li/import/12733646', // com.jdd.motorfans.MTMainActivity
      ...
      rules: [
        {
          ...
          snapshotUrls: ['https://i.gkd.li/import/12826382'],
        },
        {
          name: '点击不感兴趣',
          preKeys: 0,
          ...
          snapshotUrls: ['https://i.gkd.li/import/12829069'],
        },
      ],
    },
    {
      ...
      rules: [
        {
          ...
          snapshotUrls: ['https://i.gkd.li/import/12888087'],
        },
      ],
    },
  ],
